...
HNREADER_ALERT_OUTBOX_PATH="${HNREADER_ALERT_OUTBOX_PATH:-}"
HNREADER_APP_VERSION="${HNREADER_APP_VERSION:-1.0.0}"
HNREADER_DB_WRITE_LOCK_RETRY_ATTEMPTS="${HNREADER_DB_WRITE_LOCK_RETRY_ATTEMPTS:-2}"
HNREADER_DB_WRITE_LOCK_RETRY_BASE_SECONDS="${HNREADER_DB_WRITE_LOCK_RETRY_BASE_SECONDS:-0.1}"
HNREADER_DB_WRITE_LOCK_RETRY_MAX_SECONDS="${HNREADER_DB_WRITE_LOCK_RETRY_MAX_SECONDS:-1.0}"
...
HNREADER_CLOUD_SYNC_OUTPUT_DIR="${HNREADER_CLOUD_SYNC_OUTPUT_DIR:-}"
...
DEFAULT_GDELT_QUERY='(technology OR science OR economy OR policy) sourcelang:english'
DEFAULT_GDELT_QUERIES='technology sourcelang:english||science sourcelang:english||economy sourcelang:english||policy sourcelang:english'
...
HNREADER_GDELT_QUERIES="${HNREADER_GDELT_QUERIES:-$DEFAULT_GDELT_QUERIES}"
HNREADER_GDELT_MODE="${HNREADER_GDELT_MODE:-ArtList}"
HNREADER_GDELT_FORMAT="${HNREADER_GDELT_FORMAT:-json}"
HNREADER_GDELT_TIMESPAN="${HNREADER_GDELT_TIMESPAN:-24h}"
HNREADER_GDELT_SORT="${HNREADER_GDELT_SORT:-DateDesc}"
HNREADER_GDELT_MAX_RECORDS="${HNREADER_GDELT_MAX_RECORDS:-75}"
HNREADER_GDELT_REQUEST_TIMEOUT_SECONDS="${HNREADER_GDELT_REQUEST_TIMEOUT_SECONDS:-60}"
HNREADER_GDELT_QUERY_DELAY_SECONDS="${HNREADER_GDELT_QUERY_DELAY_SECONDS:-120}"
...
HNREADER_INGEST_INTERVAL_MAX_SECONDS="${HNREADER_INGEST_INTERVAL_MAX_SECONDS:-10800}"
...
HNREADER_INGEST_NIGHT_PAUSE_START_MINUTE="${HNREADER_INGEST_NIGHT_PAUSE_START_MINUTE:-1200}"
HNREADER_INGEST_NIGHT_PAUSE_END_MINUTE="${HNREADER_INGEST_NIGHT_PAUSE_END_MINUTE:-480}"
HNREADER_INGEST_ROUND_TIMEOUT_SECONDS="${HNREADER_INGEST_ROUND_TIMEOUT_SECONDS:-10800}"
...
HNREADER_TOPIC_MAX_ACTIVE_TOPICS="${HNREADER_TOPIC_MAX_ACTIVE_TOPICS:-16}"
...
HNREADER_INSIGHTS_EVIDENCE_WORKERS="${HNREADER_INSIGHTS_EVIDENCE_WORKERS:-4}"
HNREADER_INSIGHTS_FINAL_WORKERS="${HNREADER_INSIGHTS_FINAL_WORKERS:-3}"
...
HNREADER_INSIGHTS_RECENT_CONTEXT_DAYS="${HNREADER_INSIGHTS_RECENT_CONTEXT_DAYS:-7}"
HNREADER_INSIGHTS_NOVELTY_MIN_SCORE="${HNREADER_INSIGHTS_NOVELTY_MIN_SCORE:-25}"
HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_STORIES="${HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_STORIES:-8}"
HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_SCORE="${HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_SCORE:-100}"
HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_DESCENDANTS="${HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_DESCENDANTS:-40}"
...
HNREADER_CODEX_AUTH_FAILURE_COOLDOWN_SECONDS="${HNREADER_CODEX_AUTH_FAILURE_COOLDOWN_SECONDS:-3600}"
...
python_env_args() {
  ...
  _out_array=(
    ...
    "HNREADER_DB_WRITE_LOCK_RETRY_ATTEMPTS=$HNREADER_DB_WRITE_LOCK_RETRY_ATTEMPTS"
    "HNREADER_DB_WRITE_LOCK_RETRY_BASE_SECONDS=$HNREADER_DB_WRITE_LOCK_RETRY_BASE_SECONDS"
    "HNREADER_DB_WRITE_LOCK_RETRY_MAX_SECONDS=$HNREADER_DB_WRITE_LOCK_RETRY_MAX_SECONDS"
    "HNREADER_CLOUD_SYNC_ENABLED=$HNREADER_CLOUD_SYNC_ENABLED"
    "HNREADER_CLOUD_PUSH_URL=$HNREADER_CLOUD_PUSH_URL"
    "HNREADER_CLOUD_PUSH_SECRET=$HNREADER_CLOUD_PUSH_SECRET"
    ...
    "HNREADER_FEED_WINDOW_SIZE=$HNREADER_FEED_WINDOW_SIZE"
    "HNREADER_STORY_STORE_MAX_ROWS=$HNREADER_STORY_STORE_MAX_ROWS"
    "HNREADER_HN_API_BASE=$HNREADER_HN_API_BASE"
    "HNREADER_HN_REQUEST_TIMEOUT_SECONDS=$HNREADER_HN_REQUEST_TIMEOUT_SECONDS"
    "HNREADER_HN_RETRY_ATTEMPTS=$HNREADER_HN_RETRY_ATTEMPTS"
    "HNREADER_GDELT_ENABLED=$HNREADER_GDELT_ENABLED"
    "HNREADER_GDELT_DOC_API_URL=$HNREADER_GDELT_DOC_API_URL"
    "HNREADER_GDELT_QUERY=$HNREADER_GDELT_QUERY"
    "HNREADER_GDELT_QUERIES=$HNREADER_GDELT_QUERIES"
    "HNREADER_GDELT_MODE=$HNREADER_GDELT_MODE"
    "HNREADER_GDELT_FORMAT=$HNREADER_GDELT_FORMAT"
    "HNREADER_GDELT_TIMESPAN=$HNREADER_GDELT_TIMESPAN"
    "HNREADER_GDELT_SORT=$HNREADER_GDELT_SORT"
    "HNREADER_GDELT_MAX_RECORDS=$HNREADER_GDELT_MAX_RECORDS"
    "HNREADER_GDELT_REQUEST_TIMEOUT_SECONDS=$HNREADER_GDELT_REQUEST_TIMEOUT_SECONDS"
    "HNREADER_GDELT_QUERY_DELAY_SECONDS=$HNREADER_GDELT_QUERY_DELAY_SECONDS"
    "HNREADER_GDELT_MIN_FETCH_INTERVAL_SECONDS=$HNREADER_GDELT_MIN_FETCH_INTERVAL_SECONDS"
    "HNREADER_GDELT_MIN_FETCH_JITTER_SECONDS=$HNREADER_GDELT_MIN_FETCH_JITTER_SECONDS"
    "HNREADER_GDELT_RATE_LIMIT_COOLDOWN_SECONDS=$HNREADER_GDELT_RATE_LIMIT_COOLDOWN_SECONDS"
    "HNREADER_COMMENT_FETCH_LIMIT=$HNREADER_COMMENT_FETCH_LIMIT"
    "HNREADER_COMMENT_MAX_DEPTH=$HNREADER_COMMENT_MAX_DEPTH"
    "HNREADER_COMMENT_MIN_DESCENDANTS=$HNREADER_COMMENT_MIN_DESCENDANTS"
    "HNREADER_INGEST_INTERVAL_SECONDS=$HNREADER_INGEST_INTERVAL_SECONDS"
    "HNREADER_INGEST_INTERVAL_MIN_SECONDS=$HNREADER_INGEST_INTERVAL_MIN_SECONDS"
    "HNREADER_INGEST_INTERVAL_MAX_SECONDS=$HNREADER_INGEST_INTERVAL_MAX_SECONDS"
    "HNREADER_INGEST_NIGHT_PAUSE_ENABLED=$HNREADER_INGEST_NIGHT_PAUSE_ENABLED"
    "HNREADER_INGEST_NIGHT_PAUSE_TIMEZONE=$HNREADER_INGEST_NIGHT_PAUSE_TIMEZONE"
    "HNREADER_INGEST_NIGHT_PAUSE_START_MINUTE=$HNREADER_INGEST_NIGHT_PAUSE_START_MINUTE"
    "HNREADER_INGEST_NIGHT_PAUSE_END_MINUTE=$HNREADER_INGEST_NIGHT_PAUSE_END_MINUTE"
    "HNREADER_INGEST_ROUND_TIMEOUT_SECONDS=$HNREADER_INGEST_ROUND_TIMEOUT_SECONDS"
    "HNREADER_INGEST_DIGEST_RESERVED_SECONDS=$HNREADER_INGEST_DIGEST_RESERVED_SECONDS"
    "HNREADER_INGEST_CHILD_KILL_GRACE_SECONDS=$HNREADER_INGEST_CHILD_KILL_GRACE_SECONDS"
    "HNREADER_INGEST_FAILURE_BACKOFF_SECONDS=$HNREADER_INGEST_FAILURE_BACKOFF_SECONDS"
    "HNREADER_ENRICH_STALE_SECONDS=$HNREADER_ENRICH_STALE_SECONDS"
    "HNREADER_ENRICH_MAX_ATTEMPTS=$HNREADER_ENRICH_MAX_ATTEMPTS"
    "HNREADER_ENRICH_WORKER_COUNT=$HNREADER_ENRICH_WORKER_COUNT"
    "HNREADER_ENRICH_SESSION_STORY_LIMIT=$HNREADER_ENRICH_SESSION_STORY_LIMIT"
    "HNREADER_ENRICH_BATCH_SIZE=$HNREADER_ENRICH_BATCH_SIZE"
    "HNREADER_REENRICH_DESCENDANTS_MIN_DELTA=$HNREADER_REENRICH_DESCENDANTS_MIN_DELTA"
    "HNREADER_REENRICH_DESCENDANTS_MIN_GROWTH_PERCENT=$HNREADER_REENRICH_DESCENDANTS_MIN_GROWTH_PERCENT"
    "HNREADER_COMMENT_RETENTION_DAYS=$HNREADER_COMMENT_RETENTION_DAYS"
    "HNREADER_DIGEST_TIMEZONE=$HNREADER_DIGEST_TIMEZONE"
    "HNREADER_DIGEST_UPDATE_INTERVAL_SECONDS=$HNREADER_DIGEST_UPDATE_INTERVAL_SECONDS"
    "HNREADER_DIGEST_MIN_NEW_DONE_STORIES=$HNREADER_DIGEST_MIN_NEW_DONE_STORIES"
    "HNREADER_DIGEST_MAX_STORIES=$HNREADER_DIGEST_MAX_STORIES"
    ...
    "HNREADER_INSIGHTS_EVIDENCE_WORKERS=$HNREADER_INSIGHTS_EVIDENCE_WORKERS"
    "HNREADER_INSIGHTS_FINAL_WORKERS=$HNREADER_INSIGHTS_FINAL_WORKERS"
    ...
    "HNREADER_INSIGHTS_RECENT_CONTEXT_DAYS=$HNREADER_INSIGHTS_RECENT_CONTEXT_DAYS"
    "HNREADER_INSIGHTS_NOVELTY_MIN_SCORE=$HNREADER_INSIGHTS_NOVELTY_MIN_SCORE"
    "HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_STORIES=$HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_STORIES"
    "HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_SCORE=$HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_SCORE"
    "HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_DESCENDANTS=$HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_DESCENDANTS"
    ...
    "HNREADER_TOPIC_MAX_ACTIVE_TOPICS=$HNREADER_TOPIC_MAX_ACTIVE_TOPICS"
    "HNREADER_TOPIC_RETENTION_DAYS=$HNREADER_TOPIC_RETENTION_DAYS"
    "HNREADER_RANKING_GRACE_SECONDS=$HNREADER_RANKING_GRACE_SECONDS"
    "HNREADER_CLEANUP_STALE_GUARD_SECONDS=$HNREADER_CLEANUP_STALE_GUARD_SECONDS"
    ...
    "HNREADER_CODEX_AUTH_FAILURE_COOLDOWN_SECONDS=$HNREADER_CODEX_AUTH_FAILURE_COOLDOWN_SECONDS"
    "HNREADER_CODEX_IGNORE_USER_CONFIG=$HNREADER_CODEX_IGNORE_USER_CONFIG"
    "HNREADER_ADMIN_EMAIL_ENABLED=$HNREADER_ADMIN_EMAIL_ENABLED"
    "HNREADER_ADMIN_EMAIL_TO=$HNREADER_ADMIN_EMAIL_TO"
    "HNREADER_SMTP_HOST=$HNREADER_SMTP_HOST"
    "HNREADER_SMTP_PORT=$HNREADER_SMTP_PORT"
    "HNREADER_SMTP_USERNAME=$HNREADER_SMTP_USERNAME"
    "HNREADER_SMTP_PASSWORD=$HNREADER_SMTP_PASSWORD"
    "HNREADER_SMTP_FROM=$HNREADER_SMTP_FROM"
    "HNREADER_SMTP_STARTTLS=$HNREADER_SMTP_STARTTLS"
    "HNREADER_SMTP_SSL=$HNREADER_SMTP_SSL"
    "HNREADER_ALERT_COOLDOWN_SECONDS=$HNREADER_ALERT_COOLDOWN_SECONDS"
    "HNREADER_ALERT_OUTBOX_MAX_RECORDS=$HNREADER_ALERT_OUTBOX_MAX_RECORDS"
  )
}
...
prepare_runtime_dirs() {
  ...
  local chown_dirs=("$db_dir" "$HNREADER_LOG_DIR" "$APP_HOME" "$HNREADER_CODEX_HOME")
  ...
  if [[ -n "$HNREADER_CLOUD_SYNC_OUTPUT_DIR" ]]; then
    assert_safe_chown_dir "$HNREADER_CLOUD_SYNC_OUTPUT_DIR" "HNREADER_CLOUD_SYNC_OUTPUT_DIR"
    runtime_dirs+=("$HNREADER_CLOUD_SYNC_OUTPUT_DIR")
    chown_dirs+=("$HNREADER_CLOUD_SYNC_OUTPUT_DIR")
  fi
  if [[ -n "$HNREADER_ALERT_OUTBOX_PATH" ]]; then
    local alert_outbox_dir
    alert_outbox_dir="$(dirname "$HNREADER_ALERT_OUTBOX_PATH")"
    assert_safe_chown_dir "$alert_outbox_dir" "HNREADER_ALERT_OUTBOX_PATH directory"
    runtime_dirs+=("$alert_outbox_dir")
    chown_dirs+=("$alert_outbox_dir")
  fi
  if [[ -n "$HNREADER_AI_CONFIG_STATUS_CACHE_PATH" ]]; then
    local ai_status_cache_dir
    ai_status_cache_dir="$(dirname "$HNREADER_AI_CONFIG_STATUS_CACHE_PATH")"
    assert_safe_chown_dir "$ai_status_cache_dir" "HNREADER_AI_CONFIG_STATUS_CACHE_PATH directory"
    runtime_dirs+=("$ai_status_cache_dir")
    chown_dirs+=("$ai_status_cache_dir")
  fi
  run_root mkdir -p "${runtime_dirs[@]}"
...
$(env_line HNREADER_ALERT_OUTBOX_PATH "$HNREADER_ALERT_OUTBOX_PATH")
$(env_line HNREADER_APP_VERSION "$HNREADER_APP_VERSION")
$(env_line HNREADER_DB_WRITE_LOCK_RETRY_ATTEMPTS "$HNREADER_DB_WRITE_LOCK_RETRY_ATTEMPTS")
$(env_line HNREADER_DB_WRITE_LOCK_RETRY_BASE_SECONDS "$HNREADER_DB_WRITE_LOCK_RETRY_BASE_SECONDS")
$(env_line HNREADER_DB_WRITE_LOCK_RETRY_MAX_SECONDS "$HNREADER_DB_WRITE_LOCK_RETRY_MAX_SECONDS")
...
$(env_line HNREADER_CLOUD_SYNC_OUTPUT_DIR "$HNREADER_CLOUD_SYNC_OUTPUT_DIR")
...
$(env_line HNREADER_GDELT_ENABLED "$HNREADER_GDELT_ENABLED")
$(env_line HNREADER_GDELT_DOC_API_URL "$HNREADER_GDELT_DOC_API_URL")
$(env_line HNREADER_GDELT_QUERY "$HNREADER_GDELT_QUERY")
$(env_line HNREADER_GDELT_QUERIES "$HNREADER_GDELT_QUERIES")
$(env_line HNREADER_GDELT_MODE "$HNREADER_GDELT_MODE")
$(env_line HNREADER_GDELT_FORMAT "$HNREADER_GDELT_FORMAT")
$(env_line HNREADER_GDELT_TIMESPAN "$HNREADER_GDELT_TIMESPAN")
$(env_line HNREADER_GDELT_SORT "$HNREADER_GDELT_SORT")
$(env_line HNREADER_GDELT_MAX_RECORDS "$HNREADER_GDELT_MAX_RECORDS")
$(env_line HNREADER_GDELT_REQUEST_TIMEOUT_SECONDS "$HNREADER_GDELT_REQUEST_TIMEOUT_SECONDS")
$(env_line HNREADER_GDELT_QUERY_DELAY_SECONDS "$HNREADER_GDELT_QUERY_DELAY_SECONDS")
$(env_line HNREADER_GDELT_MIN_FETCH_INTERVAL_SECONDS "$HNREADER_GDELT_MIN_FETCH_INTERVAL_SECONDS")
$(env_line HNREADER_GDELT_MIN_FETCH_JITTER_SECONDS "$HNREADER_GDELT_MIN_FETCH_JITTER_SECONDS")
$(env_line HNREADER_GDELT_RATE_LIMIT_COOLDOWN_SECONDS "$HNREADER_GDELT_RATE_LIMIT_COOLDOWN_SECONDS")
...
$(env_line HNREADER_INGEST_NIGHT_PAUSE_ENABLED "$HNREADER_INGEST_NIGHT_PAUSE_ENABLED")
$(env_line HNREADER_INGEST_NIGHT_PAUSE_TIMEZONE "$HNREADER_INGEST_NIGHT_PAUSE_TIMEZONE")
$(env_line HNREADER_INGEST_NIGHT_PAUSE_START_MINUTE "$HNREADER_INGEST_NIGHT_PAUSE_START_MINUTE")
$(env_line HNREADER_INGEST_NIGHT_PAUSE_END_MINUTE "$HNREADER_INGEST_NIGHT_PAUSE_END_MINUTE")
...
$(env_line HNREADER_INSIGHTS_EVIDENCE_WORKERS "$HNREADER_INSIGHTS_EVIDENCE_WORKERS")
$(env_line HNREADER_INSIGHTS_FINAL_WORKERS "$HNREADER_INSIGHTS_FINAL_WORKERS")
...
$(env_line HNREADER_INSIGHTS_RECENT_CONTEXT_DAYS "$HNREADER_INSIGHTS_RECENT_CONTEXT_DAYS")
$(env_line HNREADER_INSIGHTS_NOVELTY_MIN_SCORE "$HNREADER_INSIGHTS_NOVELTY_MIN_SCORE")
$(env_line HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_STORIES "$HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_STORIES")
$(env_line HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_SCORE "$HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_SCORE")
$(env_line HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_DESCENDANTS "$HNREADER_INSIGHTS_FRESH_MATERIAL_MIN_DESCENDANTS")
...
$(env_line HNREADER_TOPIC_MAX_ACTIVE_TOPICS "$HNREADER_TOPIC_MAX_ACTIVE_TOPICS")
...
$(env_line HNREADER_CODEX_AUTH_FAILURE_COOLDOWN_SECONDS "$HNREADER_CODEX_AUTH_FAILURE_COOLDOWN_SECONDS")
...
runtime_read_write_paths() {
  local db_dir="$1"
  local paths=("$db_dir" "$HNREADER_LOG_DIR" "$APP_HOME" "$HNREADER_CODEX_HOME")
  if [[ -n "$HNREADER_CLOUD_SYNC_OUTPUT_DIR" ]]; then
    paths+=("$HNREADER_CLOUD_SYNC_OUTPUT_DIR")
  fi
  if [[ -n "$HNREADER_ALERT_OUTBOX_PATH" ]]; then
    paths+=("$(dirname "$HNREADER_ALERT_OUTBOX_PATH")")
  fi
  if [[ -n "$HNREADER_AI_CONFIG_STATUS_CACHE_PATH" ]]; then
    paths+=("$(dirname "$HNREADER_AI_CONFIG_STATUS_CACHE_PATH")")
  fi
  printf '%s' "${paths[*]}"
}
...
write_db_init_service() {
  ...
  read_write_paths="$(runtime_read_write_paths "$db_dir")"
