...
HNREADER_CLOUD_PUSH_BATCH_SIZE="${HNREADER_CLOUD_PUSH_BATCH_SIZE:-20}"
...
HNREADER_INSIGHTS_MAX_TODAY_STORIES="${HNREADER_INSIGHTS_MAX_TODAY_STORIES:-80}"
HNREADER_INSIGHTS_EVIDENCE_MAX_STORIES="${HNREADER_INSIGHTS_EVIDENCE_MAX_STORIES:-120}"
HNREADER_INSIGHTS_EVIDENCE_COMMENT_LIMIT_PER_STORY="${HNREADER_INSIGHTS_EVIDENCE_COMMENT_LIMIT_PER_STORY:-8}"
HNREADER_INSIGHTS_EVIDENCE_COMMENT_MAX_CHARS="${HNREADER_INSIGHTS_EVIDENCE_COMMENT_MAX_CHARS:-240}"
HNREADER_INSIGHTS_EVIDENCE_RAW_TEXT_MAX_CHARS="${HNREADER_INSIGHTS_EVIDENCE_RAW_TEXT_MAX_CHARS:-600}"
...
python_env_args() {
  ...
  _out_array=(
    ...
    "HNREADER_INSIGHTS_EVIDENCE_COMMENT_MAX_CHARS=$HNREADER_INSIGHTS_EVIDENCE_COMMENT_MAX_CHARS"
    "HNREADER_INSIGHTS_EVIDENCE_RAW_TEXT_MAX_CHARS=$HNREADER_INSIGHTS_EVIDENCE_RAW_TEXT_MAX_CHARS"
...
$(env_line HNREADER_INSIGHTS_EVIDENCE_COMMENT_MAX_CHARS "$HNREADER_INSIGHTS_EVIDENCE_COMMENT_MAX_CHARS")
$(env_line HNREADER_INSIGHTS_EVIDENCE_RAW_TEXT_MAX_CHARS "$HNREADER_INSIGHTS_EVIDENCE_RAW_TEXT_MAX_CHARS")
