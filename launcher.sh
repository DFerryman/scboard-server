...
HNREADER_CLOUD_SYNC_RETAINED_VERSION_COUNT="${HNREADER_CLOUD_SYNC_RETAINED_VERSION_COUNT:-6}"
...
HNREADER_STORY_IMAGES_ENABLED="${HNREADER_STORY_IMAGES_ENABLED:-false}"
HNREADER_STORY_IMAGE_UPLOAD_URL="${HNREADER_STORY_IMAGE_UPLOAD_URL:-}"
HNREADER_STORY_IMAGE_UPLOAD_SECRET="${HNREADER_STORY_IMAGE_UPLOAD_SECRET:-}"
HNREADER_STORY_IMAGE_CLOUD_PATH_PREFIX="${HNREADER_STORY_IMAGE_CLOUD_PATH_PREFIX:-hn/story-thumbs/v1}"
HNREADER_STORY_IMAGE_WORKERS="${HNREADER_STORY_IMAGE_WORKERS:-6}"
...
HNREADER_STORY_IMAGE_DELETE_BATCH_SIZE="${HNREADER_STORY_IMAGE_DELETE_BATCH_SIZE:-50}"
HNREADER_STORY_IMAGE_DOWNLOAD_TIMEOUT_SECONDS="${HNREADER_STORY_IMAGE_DOWNLOAD_TIMEOUT_SECONDS:-10}"
HNREADER_STORY_IMAGE_MAX_HTML_BYTES="${HNREADER_STORY_IMAGE_MAX_HTML_BYTES:-524288}"
HNREADER_STORY_IMAGE_MAX_BYTES="${HNREADER_STORY_IMAGE_MAX_BYTES:-5242880}"
HNREADER_STORY_IMAGE_MAX_PIXELS="${HNREADER_STORY_IMAGE_MAX_PIXELS:-40000000}"
HNREADER_STORY_IMAGE_THUMBNAIL_SIZE="${HNREADER_STORY_IMAGE_THUMBNAIL_SIZE:-96}"
HNREADER_STORY_IMAGE_DELETE_GRACE_SECONDS="${HNREADER_STORY_IMAGE_DELETE_GRACE_SECONDS:-86400}"
...
DEFAULT_INSIGHTS_UPDATE_INTERVAL_MAX_SECONDS=$((HNREADER_INSIGHTS_UPDATE_INTERVAL_SECONDS * 5 / 4))
if [ "$DEFAULT_INSIGHTS_UPDATE_INTERVAL_MAX_SECONDS" -lt "$DEFAULT_INSIGHTS_UPDATE_INTERVAL_MIN_SECONDS" ]; then
  DEFAULT_INSIGHTS_UPDATE_INTERVAL_MAX_SECONDS="$DEFAULT_INSIGHTS_UPDATE_INTERVAL_MIN_SECONDS"
fi
...
HNREADER_INSIGHTS_EVIDENCE_CACHE_RETENTION_DAYS="${HNREADER_INSIGHTS_EVIDENCE_CACHE_RETENTION_DAYS:-$((HNREADER_INSIGHTS_WINDOW_DAYS + 1))}"
HNREADER_INSIGHTS_EVIDENCE_CACHE_MAX_ENTRIES="${HNREADER_INSIGHTS_EVIDENCE_CACHE_MAX_ENTRIES:-512}"
...
python_env_args() {
  ...
  _out_array=(
    ...
    "HNREADER_CLOUD_SYNC_RETAINED_VERSION_COUNT=$HNREADER_CLOUD_SYNC_RETAINED_VERSION_COUNT"
    ...
    "HNREADER_STORY_IMAGES_ENABLED=$HNREADER_STORY_IMAGES_ENABLED"
    "HNREADER_STORY_IMAGE_UPLOAD_URL=$HNREADER_STORY_IMAGE_UPLOAD_URL"
    "HNREADER_STORY_IMAGE_UPLOAD_SECRET=$HNREADER_STORY_IMAGE_UPLOAD_SECRET"
    "HNREADER_STORY_IMAGE_CLOUD_PATH_PREFIX=$HNREADER_STORY_IMAGE_CLOUD_PATH_PREFIX"
    "HNREADER_STORY_IMAGE_WORKERS=$HNREADER_STORY_IMAGE_WORKERS"
    "HNREADER_STORY_IMAGE_UPLOAD_BATCH_SIZE=$HNREADER_STORY_IMAGE_UPLOAD_BATCH_SIZE"
    "HNREADER_STORY_IMAGE_UPLOAD_MAX_BODY_BYTES=$HNREADER_STORY_IMAGE_UPLOAD_MAX_BODY_BYTES"
    "HNREADER_STORY_IMAGE_DELETE_BATCH_SIZE=$HNREADER_STORY_IMAGE_DELETE_BATCH_SIZE"
    "HNREADER_STORY_IMAGE_DOWNLOAD_TIMEOUT_SECONDS=$HNREADER_STORY_IMAGE_DOWNLOAD_TIMEOUT_SECONDS"
    "HNREADER_STORY_IMAGE_MAX_HTML_BYTES=$HNREADER_STORY_IMAGE_MAX_HTML_BYTES"
    "HNREADER_STORY_IMAGE_MAX_BYTES=$HNREADER_STORY_IMAGE_MAX_BYTES"
    "HNREADER_STORY_IMAGE_MAX_PIXELS=$HNREADER_STORY_IMAGE_MAX_PIXELS"
    "HNREADER_STORY_IMAGE_THUMBNAIL_SIZE=$HNREADER_STORY_IMAGE_THUMBNAIL_SIZE"
    "HNREADER_STORY_IMAGE_DELETE_GRACE_SECONDS=$HNREADER_STORY_IMAGE_DELETE_GRACE_SECONDS"
    ...
    "HNREADER_INSIGHTS_UPDATE_INTERVAL_MIN_SECONDS=$HNREADER_INSIGHTS_UPDATE_INTERVAL_MIN_SECONDS"
    "HNREADER_INSIGHTS_UPDATE_INTERVAL_MAX_SECONDS=$HNREADER_INSIGHTS_UPDATE_INTERVAL_MAX_SECONDS"
    ...
    "HNREADER_INSIGHTS_PRIOR_WINDOW_EVIDENCE_MAX_RATIO=$HNREADER_INSIGHTS_PRIOR_WINDOW_EVIDENCE_MAX_RATIO"
    ...
    "HNREADER_INSIGHTS_EVIDENCE_CACHE_MAX_ENTRIES=$HNREADER_INSIGHTS_EVIDENCE_CACHE_MAX_ENTRIES"
...
$(env_line HNREADER_CLOUD_SYNC_RETAINED_VERSION_COUNT "$HNREADER_CLOUD_SYNC_RETAINED_VERSION_COUNT")
...
$(env_line HNREADER_STORY_IMAGES_ENABLED "$HNREADER_STORY_IMAGES_ENABLED")
$(env_line HNREADER_STORY_IMAGE_UPLOAD_URL "$HNREADER_STORY_IMAGE_UPLOAD_URL")
$(env_line HNREADER_STORY_IMAGE_UPLOAD_SECRET "$HNREADER_STORY_IMAGE_UPLOAD_SECRET")
$(env_line HNREADER_STORY_IMAGE_CLOUD_PATH_PREFIX "$HNREADER_STORY_IMAGE_CLOUD_PATH_PREFIX")
$(env_line HNREADER_STORY_IMAGE_WORKERS "$HNREADER_STORY_IMAGE_WORKERS")
$(env_line HNREADER_STORY_IMAGE_UPLOAD_BATCH_SIZE "$HNREADER_STORY_IMAGE_UPLOAD_BATCH_SIZE")
$(env_line HNREADER_STORY_IMAGE_UPLOAD_MAX_BODY_BYTES "$HNREADER_STORY_IMAGE_UPLOAD_MAX_BODY_BYTES")
$(env_line HNREADER_STORY_IMAGE_DELETE_BATCH_SIZE "$HNREADER_STORY_IMAGE_DELETE_BATCH_SIZE")
$(env_line HNREADER_STORY_IMAGE_DOWNLOAD_TIMEOUT_SECONDS "$HNREADER_STORY_IMAGE_DOWNLOAD_TIMEOUT_SECONDS")
$(env_line HNREADER_STORY_IMAGE_MAX_HTML_BYTES "$HNREADER_STORY_IMAGE_MAX_HTML_BYTES")
$(env_line HNREADER_STORY_IMAGE_MAX_BYTES "$HNREADER_STORY_IMAGE_MAX_BYTES")
$(env_line HNREADER_STORY_IMAGE_MAX_PIXELS "$HNREADER_STORY_IMAGE_MAX_PIXELS")
$(env_line HNREADER_STORY_IMAGE_THUMBNAIL_SIZE "$HNREADER_STORY_IMAGE_THUMBNAIL_SIZE")
$(env_line HNREADER_STORY_IMAGE_DELETE_GRACE_SECONDS "$HNREADER_STORY_IMAGE_DELETE_GRACE_SECONDS")
...
$(env_line HNREADER_INGEST_INTERVAL_MIN_SECONDS "$HNREADER_INGEST_INTERVAL_MIN_SECONDS")
$(env_line HNREADER_INGEST_INTERVAL_MAX_SECONDS "$HNREADER_INGEST_INTERVAL_MAX_SECONDS")
...
$(env_line HNREADER_INSIGHTS_UPDATE_INTERVAL_MIN_SECONDS "$HNREADER_INSIGHTS_UPDATE_INTERVAL_MIN_SECONDS")
$(env_line HNREADER_INSIGHTS_UPDATE_INTERVAL_MAX_SECONDS "$HNREADER_INSIGHTS_UPDATE_INTERVAL_MAX_SECONDS")
...
$(env_line HNREADER_INSIGHTS_PRIOR_WINDOW_EVIDENCE_MAX_RATIO "$HNREADER_INSIGHTS_PRIOR_WINDOW_EVIDENCE_MAX_RATIO")
...
$(env_line HNREADER_INSIGHTS_EVIDENCE_CACHE_MAX_ENTRIES "$HNREADER_INSIGHTS_EVIDENCE_CACHE_MAX_ENTRIES")
...
HNREADER_CLOUD_SYNC_RETAINED_VERSION_COUNT=6
