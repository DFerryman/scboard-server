...
HNREADER_INSIGHTS_UPDATE_INTERVAL_SECONDS="${HNREADER_INSIGHTS_UPDATE_INTERVAL_SECONDS:-1800}"
HNREADER_INSIGHTS_MIN_TODAY_STORIES="${HNREADER_INSIGHTS_MIN_TODAY_STORIES:-5}"
HNREADER_INSIGHTS_MAX_TODAY_STORIES="${HNREADER_INSIGHTS_MAX_TODAY_STORIES:-40}"
HNREADER_INSIGHTS_MAX_TREND_TOPICS="${HNREADER_INSIGHTS_MAX_TREND_TOPICS:-8}"
HNREADER_INSIGHTS_MAX_OPPORTUNITY_CANDIDATES="${HNREADER_INSIGHTS_MAX_OPPORTUNITY_CANDIDATES:-24}"
HNREADER_INSIGHTS_MAX_DEBATE_CANDIDATES="${HNREADER_INSIGHTS_MAX_DEBATE_CANDIDATES:-16}"
HNREADER_INSIGHTS_COMMENT_LIMIT_OPPORTUNITY="${HNREADER_INSIGHTS_COMMENT_LIMIT_OPPORTUNITY:-12}"
HNREADER_INSIGHTS_COMMENT_LIMIT_DEBATE="${HNREADER_INSIGHTS_COMMENT_LIMIT_DEBATE:-24}"
HNREADER_INSIGHTS_COMMENT_MAX_CHARS="${HNREADER_INSIGHTS_COMMENT_MAX_CHARS:-180}"
HNREADER_INSIGHTS_RAW_TEXT_MAX_CHARS="${HNREADER_INSIGHTS_RAW_TEXT_MAX_CHARS:-800}"
...
python_env_args() {
  ...
  _out_array=(
    ...
    "HNREADER_INSIGHTS_MAX_TREND_TOPICS=$HNREADER_INSIGHTS_MAX_TREND_TOPICS"
    "HNREADER_INSIGHTS_MAX_OPPORTUNITY_CANDIDATES=$HNREADER_INSIGHTS_MAX_OPPORTUNITY_CANDIDATES"
    "HNREADER_INSIGHTS_MAX_DEBATE_CANDIDATES=$HNREADER_INSIGHTS_MAX_DEBATE_CANDIDATES"
    "HNREADER_INSIGHTS_COMMENT_LIMIT_OPPORTUNITY=$HNREADER_INSIGHTS_COMMENT_LIMIT_OPPORTUNITY"
    "HNREADER_INSIGHTS_COMMENT_LIMIT_DEBATE=$HNREADER_INSIGHTS_COMMENT_LIMIT_DEBATE"
    "HNREADER_INSIGHTS_COMMENT_MAX_CHARS=$HNREADER_INSIGHTS_COMMENT_MAX_CHARS"
    "HNREADER_INSIGHTS_RAW_TEXT_MAX_CHARS=$HNREADER_INSIGHTS_RAW_TEXT_MAX_CHARS"
...
$(env_line HNREADER_INSIGHTS_MAX_TREND_TOPICS "$HNREADER_INSIGHTS_MAX_TREND_TOPICS")
$(env_line HNREADER_INSIGHTS_MAX_OPPORTUNITY_CANDIDATES "$HNREADER_INSIGHTS_MAX_OPPORTUNITY_CANDIDATES")
$(env_line HNREADER_INSIGHTS_MAX_DEBATE_CANDIDATES "$HNREADER_INSIGHTS_MAX_DEBATE_CANDIDATES")
$(env_line HNREADER_INSIGHTS_COMMENT_LIMIT_OPPORTUNITY "$HNREADER_INSIGHTS_COMMENT_LIMIT_OPPORTUNITY")
$(env_line HNREADER_INSIGHTS_COMMENT_LIMIT_DEBATE "$HNREADER_INSIGHTS_COMMENT_LIMIT_DEBATE")
$(env_line HNREADER_INSIGHTS_COMMENT_MAX_CHARS "$HNREADER_INSIGHTS_COMMENT_MAX_CHARS")
$(env_line HNREADER_INSIGHTS_RAW_TEXT_MAX_CHARS "$HNREADER_INSIGHTS_RAW_TEXT_MAX_CHARS")
