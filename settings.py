...
INSIGHTS_PRIOR_WINDOW_EVIDENCE_MAX_RATIO = _require_float_range(
    "HNREADER_INSIGHTS_PRIOR_WINDOW_EVIDENCE_MAX_RATIO",
    _env_float("HNREADER_INSIGHTS_PRIOR_WINDOW_EVIDENCE_MAX_RATIO", 0.30),
    min_value=0.0,
    max_value=0.90,
)
...
CODEX_AUTH_FAILURE_COOLDOWN_SECONDS = _require_float_range(
    "HNREADER_CODEX_AUTH_FAILURE_COOLDOWN_SECONDS",
    _env_float(
        "HNREADER_CODEX_AUTH_FAILURE_COOLDOWN_SECONDS",
        3600.0,
        fallback="HACKERMINI_CODEX_AUTH_FAILURE_COOLDOWN_SECONDS",
    ),
    min_value=0.0,
    max_value=86400.0,
)
...
_AI_ENV_NAMES = {
    ...
    "HACKERMINI_CODEX_AUTH_FAILURE_COOLDOWN_SECONDS",
...
def _reload_codex_settings_from_process_env() -> None:
    ...
    global CODEX_REQUEST_TIMEOUT_SECONDS, CODEX_AUTH_FAILURE_COOLDOWN_SECONDS
    global CODEX_IGNORE_USER_CONFIG
...
GDELT_RATE_LIMIT_COOLDOWN_SECONDS = _GDELT_CONFIGURED_RATE_LIMIT_COOLDOWN_SECONDS
