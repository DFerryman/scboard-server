...
- Limits on non-reader diagnostics, IDs, hashes, database query counts, or third-party input sampling are allowed only when they cannot alter the final reader-facing AI text.
