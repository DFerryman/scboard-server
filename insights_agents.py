...
TODAY_SIGNALS_SYSTEM_PROMPT = (
    ...
    "pain. Avoid generic hype, do not list stories, and do not "
...
OPPORTUNITY_SYSTEM_PROMPT = (
    ...
    "risk, timing, or wedge. linkedStoryIds must cite the input "
...
DEBATE_SYSTEM_PROMPT = (
    ...
    "behavior. Security boundary: candidate discussion and "
...
TOPIC_SCOUT_SYSTEM_PROMPT = (
    ...
    "against previousInsight as ranking signals, but keep product relevance "
    ...
    "disagreement. Do not exclude strong same-day evidence solely because the "
